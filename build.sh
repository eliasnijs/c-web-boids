...
FILES="${FILES} --preload-file src/view/shaders/lines.vertex.glsl"
FILES="${FILES} --preload-file src/view/shaders/lines.fragment.glsl"
...
cp ./build/boids.data ../../boids.data
